...
public class SerializableDeferredTracerTest {

    @Test
    public void test() throws IOException, ClassNotFoundException {
        Tracer.initTrace(Optional.empty(), "defaultTraceId");

        SerializableDeferredTracer deferredTracer = new SerializableDeferredTracer("deferred");
        ...
        try (ObjectInputStream objectInputStream = new ObjectInputStream(bais)) {
            SerializableDeferredTracer deserialized = (SerializableDeferredTracer) objectInputStream.readObject();
