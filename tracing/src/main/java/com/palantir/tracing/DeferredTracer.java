...
public final class DeferredTracer implements Serializable {
    ...
    public DeferredTracer(@Safe String operation, @Safe Map<String, String> metadata) {
        ...
        if (maybeTrace.isPresent()) {
            ...
            this.originUserAgent = trace.getOriginUserAgent().orElse(null);
        } else {
            this.traceId = null;
            this.requestId = null;
    ...
    CloseableTrace withTrace() {
        ...
        Tracer.setTrace(
                Trace.of(isObservable, traceId, Optional.ofNullable(requestId), Optional.ofNullable(originUserAgent)));
